...
<html lang="en">
  <head>
    ...
    <link href="assets/css/main.css?v47" rel="stylesheet" />
    <style>
              ...
              <div class="banner-wrapper">
                <div class="container-fluid container-xl">
                  <div class="banner-text" style="color:white">
                    <h2 style=" font-size: 60px; font-weight: bold; line-height: 68px;    margin-bottom: 20px;">See you at the Trade Fair </h2>
                    <p style="margin-top:10px;margin-bottom:30px"> We will be participating in a <span style="color: #f3bf6f;">trade fair event</span> to showcase our latest innovations and technologies. Meet us at <span style="color: #f3bf6f;">Stall #18-19</span> to explore the latest services and speak with knowledgeable representatives at the event. </p>
                    <a href="https://www.facebook.com/Comium.Gambia" class="know-btn" target="_blank" class="btn btn-info">Know more</a>
                  </div>
                </div>
              </div>
              <picture>
                <source srcset="assets/img/web3.webp" media="(min-width: 768px)" alt="Global Financial Technology D" height="100%" width="100%">
                <img loading="lazy" src="assets/img/banner-4.webp" alt="Global Financial Technology M" width="100%">
              </picture>
            </div>
           <div class="swiper-slide">
              <div class="banner-wrapper">
                <div class="container-fluid container-xl">
                  <div class="banner-text" style="color:white">
                    <h2 style="font-size: 60px; font-weight: bold; line-height: 68px;    margin-bottom: 20px;">To all Comium subscribers </h2>
                    <!-- <p style="margin-top:10px;font-weight:bold;" class="bann-font">Replace your old SIM with 4G+ SIM card </p><p style="margin-top:10px;margin-bottom:0px;line-height:1"  class="bann-font">& enjoy <span style="font-weight:900">5GB</span> data for </p><p style="margin-top:10px;font-size:5rem;margin-top:0px;line-height:1">FREE</p><p style=""  class="bann-font">Visit us at the <span style="font-weight:bold">Trade Fair</span> or at
our <span style="font-weight:bold">customer care desks to make the switch</span></p> -->
                    <p style="line-height:1.5;margin-bottom:0px" class="bann-font">Replace your old SIM with 4G+ SIM card </p>
                    <p style="line-height:1.5;margin-bottom:0px">and enjoy <span style="font-weight:900">5GB</span> data for <span style="font-weight:bold">FREE</span>
                    </p>
                    <p style="line-height:1.5;margin-bottom:0px">Visit us at the <span style="">Trade Fair</span> or at our <span style="">customer care desks to make the switch</span>
                    </p>
                  </div>
                </div>
              </div>
              <picture>
                <source srcset="assets/img/web4.webp" media="(min-width: 768px)" alt="Global Financial Technology D" width="100%">
                <img loading="lazy" src="assets/img/mobile4.webp" alt="Global Financial Technology M" width="100%">
              </picture>
            </div>
            <div class="swiper-slide">
              <div class="banner-wrapper">
            ...
            <div class="swiper-slide">
              <div class="banner-wrapper">
                <div class="container-fluid container-xl">
                  <div class="banner-text" style="color:white;">
                    <h2 class="fix-width" style=" font-size: 60px; font-weight: bold; line-height: 68px; margin-bottom: 20px;letter-spacing: -0.01em;"> Connect for less! </h2>
                    <p style="margin-top:10px;"> Get the best value for your money with KaCha! Enjoy the most attractive VOICE/SMS bundles in the market. Stay connected with your loved ones and get things done faster, all at an affordable price. </p>
                  </div>
                </div>
              </div>
              <picture>
                <source srcset="assets/img/banner2.webp" media="(min-width: 768px)" alt="Simple Banking D" width="100%">
                <img loading="lazy" src="assets/img/banner2-mobile.webp" alt="Simple Banking M" width="100%">
              </picture>
            </div>
    ...
    color: #E1251B;padding:0">Comium History <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                  <div class="service-box orange">
                    ...
                    <h3>KaCha</h3>
                    <p class="kasha-mobile"> D25: 100 minutes / 100 SMS <br>To subscribe, dial 155 <br>
                      <br>D50: 250 minutes / 500 SMS <br>To subscribe, dial 156 <br>
                      <br>D100: 600 minutes / 1000 SMS <br>To subscribe, dial 157 <br>
                      <br> D200: 1400 minutes / 2000 SMS <br>To subscribe, dial 158 <br>
                      <br> With Comium, your loyalty is always rewarded! Subscribe, and get the chance to win a TV or D1000 cash every week!
                    </p>
                    ...
                    <p class="ran-overlay"> D25: 100 minutes / 100 SMS <br>To subscribe, dial 155 <br>
                      <br>D50: 250 minutes / 500 SMS <br>To subscribe, dial 156 <br>
                      <br>D100: 600 minutes / 1000 SMS <br>To subscribe, dial 157 <br>
                      <br> D200: 1400 minutes / 2000 SMS <br>To subscribe, dial 158
                    </p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                  <div class="service-box red ">
                    <span>
                      <img src="assets/img/ic2.svg?v3" />
                    </span>
                    <h3>Internet Service Provider</h3>
                    <p class="isp-mobile"> We provide the fastest internet coverage in The Gambia with 2 main subscriptions: <br> - For businesses <br> - For individuals. <br>
                      <br> Call Comium centers on 111 for free to activate this service within 24 hours. <br>
                    </p>
                    <p class="isp-overlay"> Call Comium centers on 111 for free to activate this service within 24 hours. </p>
                    <p class="isp-random"> We provide the fastest internet coverage in The Gambia with 2 main subscriptions: <br> - For businesses <br> - For individuals. </p>
                  </div>
                </div>
              </div>
            </div>
    ...
    line-height: 42px;
    font-weight: 700;
    color: #111921;">Join Our Family!</p>
                <p class="padding-here" style="
                margin: 15px 0 30px 0;
                line-height: 24px;
                font-weight: 400;
          ...
          <section class="carrousl">
            <div id="carousel-afric" class="slick-track">
              <div>
                <img src="assets/img/p1.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p2.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p3.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p4.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p5.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p6.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p7.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p8.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p9.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p10.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p11.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p12.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p13.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p14.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p15.webp" class="img-responsive" />
              </div>
              <div>
                <img src="assets/img/p16.webp" class="img-responsive" />
              </div>
            </div>
          </section>
          <!-- Modal Order Form -->
    ...
    background-repeat: no-repeat;">
                      ...
                      <div class="col-md-12 text-center">
                        ...
                        <button type="submit" class="msg-btn" id="btn-mailer" value="Send An Email">Send message</button>
                      </div>
                    </div>
                  </form>
                </div>
...
"> We, at Comium offer the best-in-class customer service. Our team of trained professionals is dedicated to you and always ready to assist you, answer all your enquiries, and explain any service or offer you need 24/7. </p>
        ...
        <script src="assets/js/mixall.js?v6"></script>
  </body>
</html>